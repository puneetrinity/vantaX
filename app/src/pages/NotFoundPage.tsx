  ...
  return (
    <>
      ...
      <section className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-text-muted text-[13px] mb-8 max-w-md">
          The page you're looking for doesn't exist or has been moved.
        </p>
        <Link
          to="/"
          className="px-6 py-3 text-[13px] font-bold uppercase tracking-wider bg-gold-500 text-bg hover:bg-gold-400 transition-colors"
        >
          cd ~/home
        </Link>
      </section>
